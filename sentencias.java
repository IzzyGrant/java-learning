...
public class sentencias {
		...
		System.out.println("Con la sentencia 'IF' podremos obtener un resultado si se cumple ciera condicion" + nuevaLinea);
        ...
        System.out.println(nuevaLinea + "La sentencia 'FOR' podemos determinar cuantas veces se cumplirá un ciclo." + nuevaLinea);
        System.out.println("Ingrese un valor menor de 20 preferentemente para cumplir un numero de ciclos de 1 al numero introducido: ");

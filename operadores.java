...
public class operadores {
	...
	public static void main(String[] args) {
		...
		String nuevaLinea = System.getProperty("line.separator"); // esta declaracion regresara una nueva linea cuando
																	// sea llamada como "newLine"
		...
		System.out.println(
				"Tenenmos los siguientes tipos de operadores. Introduzca 2 valores por operacion:" + nuevaLinea);
		...
		System.out.println("Finalizo en " + totalTime + " segundos.");// muestra el tiempo que paso en completar el
																		// programa.
